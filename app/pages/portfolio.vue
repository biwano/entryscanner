...
// Watch for address and redirect to profile if not set and not loading
watch(
  [address, isLoading],
  ([newAddress, newLoading]) => {
    if (!newAddress && !newLoading) {
      router.push("/profile");
    }
  },
  { immediate: true }
    ...
    >
      ...
      <div class="space-y-2">
        ...
        <p class="text-gray-500 max-w-sm">
          Please enter your Hyperliquid wallet address or API key in the Profile
          Settings to access your portfolio.
        </p>
      </div>
