...
export type UserSubAccount = Tables<"user_sub_accounts">;
...
export type UserSubAccountInsert = TablesInsert<"user_sub_accounts">;
...
export type UserSubAccountUpdate = TablesUpdate<"user_sub_accounts">;
